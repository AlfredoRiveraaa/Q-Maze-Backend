...
('Matemáticas', '¿Qué tipo de ángulo mide exactamente 90°?', '["Agudo", "Obtuso", "Recto", "Llano"]', 2, 8),
('Matemáticas', '¿Cuál es el valor de Pi (π) aproximado a dos decimales?', '["3.12", "3.14", "3.16", "3.18"]', 1, 8),
('Matemáticas', 'En la fórmula E = mc2, ¿qué representa la E?', '["Electricidad", "Energía", "Ecuación", "Expansión"]', 1, 10),
('Matemáticas', '¿Cómo se llama la figura geométrica de 12 lados?', '["Decágono", "Octágono", "Dodecágono", "Eneágono"]', 2, 10),
('Matemáticas', '¿Cuál es el resultado de 15 * 0 + 5?', '["0", "5", "15", "20"]', 1, 8),
...
('Matemáticas', '¿Qué propiedad matemática establece que a * (b + c) = a * b + a * c?', '["Conmutativa", "Asociativa", "Distributiva", "Identidad"]', 2, 15),
